...
def diffdrive_ik(linear: float, angular: float, radius: float, separation: float) -> tuple[float, float]:
...
def diffdrive_fk(left_vel: float, right_vel: float, radius: float, separation: float) -> tuple[float, float]:
